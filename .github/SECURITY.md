...
- Command injection via crafted completion candidates
- Escape sequence injection that persists after plugin exit
- Sensitive data exposure through terminal capture/restore
