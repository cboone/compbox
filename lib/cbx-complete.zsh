...
function cbx-complete() {
  ...
  # Stock behavior is preserved for no-match, single-match, and
  # unambiguous-prefix cases. Menu suppression applies only when
  # the custom popup is actually entering (Phase 4+).
